...
urlpatterns = [
    ...
    re_path("devices", views.device_list, name="device_list"),
    ...
    re_path("bgp_nbrs", bgp.bgp_nbr_config, name="bgp_nbr"),
    re_path("port_groups", port_group.port_groups, name="port_groups"),
